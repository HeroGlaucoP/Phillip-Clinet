...
public abstract class Command {
    ...
    public static void sentClientMessage(String message) {
        if (MsgWaterMark)
            mc.player.sendMessage(new TextComponentString(ChatFormatting.GRAY + "[" + ChatFormatting.RED + "1pop on top" + ChatFormatting.GRAY + "]" + cf + message));
        else
